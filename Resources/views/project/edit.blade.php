                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="pagetitle d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <a title="بازگشت" href="{{ route('admin.projects.index') }}"
                            ...
                            <form method="POST" id="form" action="{{route('admin.project.update',$project->id)}} " enctype="multipart/form-data">
                                {{ csrf_field() }}
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="tab-content pt-2" id="myTabjustifiedContent">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-12 mb-2">
                                                            ...
                                                            <input type="text" class="form-control" id="title_fa"
                                                                   name="title_fa" value="{{ $project->title_fa }}">
                                                            @error('title_fa')
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            ...
                                                            <textarea rows="10" type="text" class="form-control"
                                                                      ...
                                                                      name="short_description_fa">{{ $project->short_description_fa }}</textarea>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <textarea rows="10" type="text" class="form-control"
                                                                      id="description_fa"
                                                                      name="description_fa">{{ $project->description_fa }}</textarea>
                                                    ...
                                                    <div class="row text-left direction-ltr">
                                                        <div class="col-md-6 col-12 mb-2">
                                                            ...
                                                            <input type="text" class="form-control" id="title_en"
                                                                   name="title_en" value="{{ $project->title_en }}">
                                                            @error('title_en')
                                                            <div class="validate_error">
                                                                {{ $message }}
                                                            </div>
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            ...
                                                            <textarea rows="10" type="text" class="form-control"
                                                                      ...
                                                                      name="short_description_en">{{ $project->short_description_en }}</textarea>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <textarea type="text" class="form-control"
                                                                      id="description_en"
                                                                      name="description_en">{{ $project->description_en }}</textarea>
                                            ...
                                            <div class="tab-pane fade"
                                                ...
                                                <section class="section dashboard tab-pane mt-5" id="home-justified"
                                                    ...
                                                    <div class="row">
                                                        <div class="row">
                                                            <img class="image-thumbnail img-thumbnail rounded mx-auto d-block" src="{{imageExist(env('PROJECT_IMAGE_FILE'),$project->image)}}">
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 col-12 position-relative">
                                                            ...
                                                            <input aria-label="انتخاب کنید" class="form-control"
                                                                   type="text" id="alias"
                                                                   name="alias" value="{{ $project->alias }}" >
                                                            @error('alias')
                                                            <div class="validate_error">
                                                                {{ $message }}
                                                            </div>
                                                        ...
                                                        <div class="col-md-6 col-12 position-relative mt-3">
                                                            ...
                                                            <select multiple="multiple" class="selectpicker form-control" name="menus_id[]" id="menu">
                                                                ...
                                                                @foreach($menus as $menu)
                                                                    <option {{in_array($menu->id,$project->menus()->pluck('id')->all()) ? 'selected' : ''}} value="{{$menu->id}}">{{$menu->title_fa ?? $menu->title_en }}</option>
                                                                @endforeach
                                                            </select>
