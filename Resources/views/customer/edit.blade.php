                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" id="form" action="{{route('admin.customer.update',['customer'=>$customer->id])}} " enctype="multipart/form-data">
                                {{ csrf_field() }}
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="tab-content pt-2" id="myTabjustifiedContent">
                                            <div class="tab-pane fade show active"
                                                ...
                                                <section class="section dashboard tab-pane fade show active mt-5"
                                                    ...
                                                    <div class="row">
                                                        <div class="row">
                                                            <img class="image-thumbnail img-thumbnail rounded mx-auto d-block" src="{{imageExist(env('CUSTOMER_IMAGE_FILE'),$customer->logo)}}">
                                                        </div>
                                                        <div class="col-md-6 col-12 mb-2">
                                                            <label for="title" class="form-label">نام مشتری :</label>
                                                            <input type="text" class="form-control" id="title"
                                                                   name="title" value="{{ $customer->title }}">
                                                            @error('title')
                                                        ...
                                                        <div class="col-md-6 col-12 mb-2">
                                                            ...
                                                            <input type="file" class="form-control" id="image"
                                                                   name="image" value="{{ $customer->logo  }}">
