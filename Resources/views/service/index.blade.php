...
@section('script')
    <script>
        ...
        function Remove() {
            let id = $('#id').val();
            let url = '{{ route('admin.service.destroy',['service'=>':service']) }}';
        ...
        function GroupRemove() {
            let id = $('#id').val();
            let url = '{{ route('admin.service.GroupRemove') }}';
            $.ajax({
                url: url,
                data: {
                    _token: "{{ csrf_token() }}",
...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-between">
            <h1 class="w-50">خدمات صفحه اصلی</h1>
            <div class="d-flex w-50">
                <select onchange="show_per_page(this,'{{ route('admin.services.index') }}')" class="form-control form-control-sm ms-3">
                ...
                <a title="اضافه کردن خدمات جدید" href="{{ route('admin.service.create') }}"
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col">
                                                    ...
                                                    <a title="EDIT" class="btn btn-sm btn-info mr-3"
                                                       href="{{ route('admin.service.edit' , ['service' => $item->id]) }}">
