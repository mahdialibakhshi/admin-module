                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="pagetitle d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <a title="بازگشت" href="{{ route('admin.services.index') }}"
                            ...
                            <form method="POST" id="form" action="{{route('admin.service.update',$service->id)}} " enctype="multipart/form-data">
                                {{ csrf_field() }}
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="tab-content pt-2" id="myTabjustifiedContent">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-12 mb-2">
                                                            ...
                                                            <input type="text" class="form-control" id="title_fa"
                                                                   name="title_fa" value="{{ $service->title_fa }}">
                                                            @error('title_fa')
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            ...
                                                            <textarea rows="10" type="text" class="form-control"
                                                                      ...
                                                                      name="short_description_fa">{{ $service->short_description_fa }}</textarea>
                                                    ...
                                                    <div class="row text-left direction-ltr">
                                                        <div class="col-md-6 col-12 mb-2">
                                                            ...
                                                            <input type="text" class="form-control" id="title_en"
                                                                   name="title_en" value="{{ $service->title_en }}">
                                                            @error('title_en')
                                                            <div class="validate_error">
                                                                {{ $message }}
                                                            </div>
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            ...
                                                            <textarea rows="10" type="text" class="form-control"
                                                                      ...
                                                                      name="short_description_en">{{ $service->short_description_en }}</textarea>
                                            ...
                                            <div class="tab-pane fade"
                                                ...
                                                <section class="section dashboard tab-pane mt-5" id="home-justified"
                                                    ...
                                                    <div class="row">
                                                        <div class="row">
                                                            <img class="image-thumbnail img-thumbnail rounded mx-auto d-block" src="{{imageExist(env('SERVICE_IMAGE_FILE'),$service->image)}}">
                                                        </div>
