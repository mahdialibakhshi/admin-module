                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" enctype="multipart/form-data" id="form"  action="{{route('admin.blog.store')}} ">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-12 position-relative">
                                                            <label for="menu" class="form-label mb-3">انتخاب دسته بندی
                                                                :</label>
                                                            <select multiple="multiple" class="select-picker form-control" name="menus_id[]" id="menu">
